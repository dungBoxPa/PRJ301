...
public class AddServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Event> evList = dao.getAllEvent();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Product p = new Product(productName, quantity, price, discount, edition, screen_size, screen_tech, back_camera, front_camera, chip, ram, internal_mem, pin, sim, OS, screen_resol, size, weight, bluetooth, full_img_path, rating_score, dao1.existedCategory(cate_id), dao1.checkEvent(event_id));
            dao.insert(p);
