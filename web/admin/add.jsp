                    ...
                    <div class="hidden-add-form" id="adding-form">
                        <div class="content-table" style="margin-top: 10px;">
                            <form action="add" method="POST">
                                <label>Điền thông tin dưới để add sản phẩm vào kho hàng!</label>
                                <table class="styled-table" border="1" style="width: 100%">
                                    <tbody>
                                        <tr>
                                            <td><label>Nhập tên sản phẩm:</label></td>
                                            <td><input name="name" type="text" class="style-input" placeholder="Nhập tên sản phẩm:..."/></td>
                                            <td><label>Nhập phiên bản của điện thoại</label></td>
                                            <td><input name="edition" type="text" class="style-input" placeholder="Phiên bản của điện thoại..."/></td>
                                        </tr>
                                        <tr>
                                            <td><label>Nhập số lượng sản phẩm:</label></td>
                                            <td><input name="quantity" type="number" class="style-input" placeholder="Nhập số lượng..."/></td>
                                            <td><label>Nhập giá của sản phẩm:</label></td>
                                            <td>
                                                <input type="number" name="price" class="style-input"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label>Nhập khuyến mãi</label></td>
                                            <td><input name="discount" type="number" class="style-input" placeholder="Nhập discount..."/></td>
                                            <td><label>Kích thước màn hình</label></td>
                                            <td><input name="screen_size" type="text" class="style-input" placeholder="Kích thước màn hình..."/></td>
                                        </tr>
                                        <tr>
                                            <td><label>Công nghệ màn hình:</label></td>
                                            <td><input name="screen_tech" type="text" class="style-input" placeholder="Công nghệ màn hình..."/></td>
                                            <td><label>Độ phân giải:</label></td>
                                            <td><input name="screen_resol" type="text" class="style-input" placeholder="Độ phân giải màn hình..."/></td>
                                        </tr>
                                        <tr>
                                            <td><label>Camera sau:</label></td>
                                            <td><input name="back_camera" type="text" class="style-input" placeholder="Camera sau..."/></td>
                                            <td><label>Camera trước:</label></td>
                                            <td><input name="front_camera" type="text" class="style-input" placeholder="Camera trước..."/></td>
                                        </tr>
                                        <tr>
                                            <td><label>Chip:</label></td>
                                            <td><input name="chip" type="text" class="style-input" placeholder="Chip..."/></td>
                                            <td><label>Ram:</label></td>
                                            <td><input name="ram" type="text" class="style-input" placeholder="Ram..."/></td>
                                        </tr>
                                        <tr>
                                            <td><label>Dung lượng bộ nhớ:</label></td>
                                            <td><input name="internal_mem" type="text" class="style-input" placeholder="Dung lượng bộ nhớ..."/></td>
                                            <td><label>PIN:</label></td>
                                            <td><input name="pin" type="text" class="style-input" placeholder="PIN..."/></td>
                                        </tr>
                                        <tr>
                                            <td><label>Thẻ sim:</label></td>
                                            <td><input name="sim" type="text" class="style-input" placeholder="Thẻ sim..."/></td>
                                            <td><label>Hệ điều hành:</label></td>
                                            <td><input name="OS" type="text" class="style-input" placeholder="Hệ điều hành..."/></td>
                                        </tr>
                                        <tr>
                                            <td><label>Kích thước(size):</label></td>
                                            <td><input name="size" type="text" class="style-input" placeholder="Kích thước..."/></td>
                                            <td><label>Khối lượng:</label></td>
                                            <td><input name="weight" type="text" class="style-input" placeholder="Khối lượng..."/></td>
                                        </tr>
                                        <tr>
                                            <td><label>Thiết bị bluetooth:</label></td>
                                            <td><input name="bluetooth" type="text" class="style-input" placeholder="Bluetooth..."/></td>
